...
datasets/bicyclerisk			Datasets for risk. The first line should be text and the subsequent lines should contain: Node ID, latitude, longitude, altitude (m), and the risk
datasets/streets			Datasets for street grids. The first line should be text and the subsequent lines should contain: Node ID, [latitude, longite, altitude(m)], [node IDs of the connected street grid points]
...
manual.pdf 				[Soon to come] A description of how to use the bike route recommender and how to extend its functionality by adding custom datasets and cost and graph search functions